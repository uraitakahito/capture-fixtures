...
[capture-ledger](https://github.com/uraitakahito/capture-ledger) integration tests. It controls
...
- [capture-ledger](https://github.com/uraitakahito/capture-ledger) — reads URLs from Postgres and drives BrowserHive.
